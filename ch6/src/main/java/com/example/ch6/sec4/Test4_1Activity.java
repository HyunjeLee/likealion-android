...
public class Test4_1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebSettings settings = binding.wv1.getSettings();
        ...
        binding.btnLine.setOnClickListener(view -> {
            binding.wv1.loadUrl("javascript:lineChart()");
        });
        binding.btnBar.setOnClickListener(view -> {
        ...
        binding.wv1.setWebChromeClient(new MyWebChrome());
    }
